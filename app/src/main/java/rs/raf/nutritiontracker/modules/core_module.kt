...
import rs.raf.nutritiontracker.BuildConfig
...
val coreModule = module {
    ...
    // koin instancira retrofit, pogleda sta retrofit prima kao parametre i get automatski vrati
    // objekat koji mu treba jer postoje jedinstvene instance
    single { createRetrofit(moshi = get(), httpClient = get()) }

    // koin instancira jedinstven objekat moshi-ja
    single { createMoshi() }

    // koin instancira jedinstven objekat httpClienta
